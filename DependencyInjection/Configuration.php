            ...
            ->children()
                ->arrayNode('tags')
                    ...
                    ->children()
                        ...
                        ->end()
                        ->scalarNode('custom_expression_class')
                            ->defaultNull()
                            ->info('Class name of a custom ExpressionLanugage class.')
                            ->validate()
                                ->ifTrue(function ($v) {return !empty($v['custom_expression_class']) && !class_exists($v['custom_expression_class']);})
                                ->thenInvalid('Configured a custom_expression_class but the class is not available')
                            ->end()
                        ->end()
                        ->scalarNode('header')
